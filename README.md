...
Задача спринта - пересобрать функционал проекта [Mesto](https://kamen-raven.github.io/mesto/) на React с добавлением страниц регистрации и авторизации. Вся функциональность приложения  доступна только авторизованным пользователям. Добавлены два роута:
* /sign-up — для регистрации пользователя;
* /sign-in — для авторизации пользователя.
Основной контент защищен от неавторизованных пользователей при помощи *ProtectedRoute*.
Аутентификация пользователя реализована при помощи запросов с соответствующими методами к соответствующим эндпойнтам. Также реализована работа с локальным хранилищем и токеном, что позволяет созранить данные пользователя при повторном визите.
...
6. Сайт передает запросы на сервер **https://mesto.nomoreparties.co** и **https://auth.nomoreparties.co**;
7. Выполнение проекта осуществлялось в программе VSCode с применением системы контроля версий Git.

___

Сайт доступен на [GitHub Pages](https://kamen-raven.github.io/react-mesto-auth/)
